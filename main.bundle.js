...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__blockly_blockly_component__ = __webpack_require__("../../../../../src/app/blockly/blockly.component.ts");
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_12__blockly_blockly_component__["a" /* BlocklyComponent */],
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* RouterModule */].forRoot(__WEBPACK_IMPORTED_MODULE_6__app_routing__["a" /* AppRoutes */]),
            ...
            __WEBPACK_IMPORTED_MODULE_11__ngui_map__["a" /* NguiMapModule */].forRoot({ apiUrl: 'https://maps.google.com/maps/api/js?key=AIzaSyBr-tgUtpm8cyjYVQDrjs8YpZH7zBNWPuY' }),
...
var BlocklyComponent = (function () {
    function BlocklyComponent(_editorService) {
        ...
        this._openFileSubscription = this._editorService.open.subscribe(function (name) {
            return _this.openFile(name);
        });
    }
...
var ROUTES = [
    ...
    { path: 'typography', title: 'File manager', icon: 'ti-view-list-alt', class: '' },
...
module.exports = "<div class=\"container-fluid\">\r\n    <div class=\"row\">\r\n        <div class=\"col-md-10\">\r\n            <div class=\"card\">\r\n                <textarea   type=\"text\"  placeholder=\"Enter your code here\" style=\"color:black; margin: 25px 20px;background-color:rgb(196, 225, 253); padding:10px 10px; border-radius: 8px;\" rows=\"20\" cols=\"110\" #codedata ></textarea>\r\n                <div style=\"text-align: right; padding:0px 10px 10px 10px; \">\r\n                    <button class=\"btn\" style=\"width:200px; height:35px; Font-size:12px; padding:5px;  border-radius: 5px;\" (click)=\"getcode(codedata.value);\" ><i class=\"fa fa-download\" aria-hidden=\"true\"></i>DOWNLOAD</button>\r\n                    <button class=\"btn\"  style=\"width:200px; height:35px; Font-size:12px; padding:5px; border-radius: 5px;\"(click)=\"getMyBlog();\">STOP</button>\r\n                </div>\r\n                \r\n            </div>\r\n        </div> \r\n      \r\n    </div>\r\n</div>\r\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ng2_mqtt_mqttws31__ = __webpack_require__("../../../../ng2-mqtt/mqttws31.js");
...
var TableComponent = (function () {
    function TableComponent(_http) {
        this._http = _http;
        this.apiUrl = 'http://ezzigbeeapi.herokuapp.com/Stop';
        this.data = null;
    ...
    TableComponent.prototype.getMyBlog = function () {
        var _this = this;
    ...
    TableComponent.prototype.onConnected = function () {
        console.log("Connected");
        this.client.subscribe("EzZigBee/Demo/LoadCode");
        this.sendMessage('Web connected to mqtt ');
    };
    TableComponent.prototype.sendMessage = function (message) {
    ...
    TableComponent.prototype.onMessage = function () {
        this.client.onMessageArrived = function (message) {
            console.log('Message arrived : ' + message.payloadString);
        };
    };
    TableComponent.prototype.onConnectionLost = function () {
        this.client.onConnectionLost = function (responseObject) {
            console.log('Connection lost : ' + JSON.stringify(responseObject));
        };
    };
    TableComponent.prototype.getcode = function (code) {
        //console.log(code);
        var packet = new __WEBPACK_IMPORTED_MODULE_3_ng2_mqtt_mqttws31__["Paho"].MQTT.Message(code.toString());
        packet.destinationName = "EzZigBee/Demo/LoadCode";
        this.client.send(packet);
    };
...
module.exports = "\r\n\r\n<div class=\"container-fluid\">\r\n    <div class=\"row\">\r\n        <div class=\"col-lg-4 col-md-5\" *ngFor=\"let a of data\">\r\n            <div class=\"card card-user\" style=\"text-align: center;\">\r\n                <div style=\"padding:10px; text-align:right;Font-size: 16px;\">\r\n                    <span style=\"float:left; font-weight:bold;padding: 0px 10px;Font-size: 18px;\"> {{a.Name}}</span>\r\n                    <span class=\"ti-pencil\"></span>\r\n                    <span class=\"ti-close\"></span>\r\n                </div>\r\n                <hr>\r\n                <p> plug in bedroom</p>\r\n                <h5 style=\" font-weight:bold;\"> IEEE Address </h5>\r\n                {{a.SHR}}\r\n                <hr>\r\n                <div class=\"text-center\">\r\n                    <div class=\"row\">\r\n                        <div class=\"col-lg-6\">\r\n                            <span style=\"color:black\">Test output 1</span> \r\n                            <br>\r\n                            <label class=\"switch\">\r\n                                <input type=\"checkbox\" (change)=\"check1($event)\" value=\"{{a.Name}}\">\r\n                                <span class=\"slider round\"></span>\r\n                            </label>\r\n                        </div>\r\n                        <div class=\"col-lg-6\">\r\n                            <span style=\"color:black\">Test output 2</span>\r\n                            <br>\r\n                            <label class=\"switch\">\r\n                                <input type=\"checkbox\" (change)=\"check2($event)\" value=\"{{a.Name}}\">\r\n                                <span class=\"slider round\"></span>\r\n                            </label>\r\n                        </div>\r\n                        <!-- <button class=\"btn\" style=\"width:250px; margin: 2px 2px 2px 2px;\">Monitor</button> -->\r\n                        <button type=\"button\" class=\"btn btn-primary\" style=\"width:250px; margin: 2px 2px 2px 2px;\" (click)=\"openModal(template)\">Monitor</button>\r\n                        \r\n                            <ng-template #template>\r\n                                <div class=\"modal-header\">\r\n                                   \r\n                                    <button type=\"button\" class=\"close pull-right\" aria-label=\"Close\" (click)=\"modalRef.hide()\" style=\"margin:-12px -5px;\">\r\n                                        <span aria-hidden=\"true\">&times;</span>\r\n                                    </button>\r\n                                    <h4 class=\"modal-title pull-left\" style=\"margin:-12px 10px;\">Monitor</h4>\r\n                                </div>\r\n                                <div class=\"modal-body\" *ngFor=\"let b of sensor\" style=\"text-Align:center\">\r\n                                        <div class=\"row\">\r\n                                                <div class=\"col-lg-6\">\r\n                                                        <h3>Sensor Port 1 :</h3>\r\n                                                </div>\r\n                                                <div class=\"col-lg-6\">\r\n                                                        <h3>{{b.Sensor1}}  </h3>\r\n                                                </div>\r\n                                                <div class=\"col-lg-6\">\r\n                                                        <h3>Sensor Port 2 :</h3>\r\n                                                </div>\r\n                                                <div class=\"col-lg-6\">\r\n                                                        <h3>{{b.Sensor2}}  </h3>\r\n                                                </div>\r\n                                        </div>\r\n                                   \r\n                                \r\n                                     <!-- <canvas baseChart\r\n                                    [datasets]=\"barChartData\"\r\n                                    [labels]=\"barChartLabels\"\r\n                                    [options]=\"barChartOptions\"\r\n                                    [legend]=\"barChartLegend\"\r\n                                    [chartType]=\"barChartType\"\r\n                                    (chartHover)=\"chartHovered($event)\"\r\n                                    (chartClick)=\"chartClicked($event)\"></canvas> -->\r\n                                    \r\n                                </div>\r\n                            </ng-template>\r\n                        <button class=\"btn\" style=\"width:250px; margin: 2px 2px 2px 2px;\" (click)=\"beep(a.Name);\">Identify node</button>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n        </div>\r\n\r\n\r\n        <div class=\"col-lg-4 col-md-5\" style=\"text-Align:center;\">\r\n\r\n            <img src=\"http://downloadicons.net/sites/default/files/plus-icon-27951.png\" alt=\"plus\" width=\"250\" height=\"250\">\r\n\r\n        </div>\r\n    </div>\r\n</div>"
...
var UserComponent = (function () {
    function UserComponent(_http, modalService) {
        var _this = this;
        this._http = _http;
        this.modalService = modalService;
        this.apiUrl = 'https://ezzigbeeapi.herokuapp.com/Dashboard';
        this.data = null;
        this.sensor = null;
        //  chart
        ...
        this.barChartLabels = ['Sensor 1', 'Sensor 2'];
    ...
    UserComponent.prototype.getMyBlog = function () {
        var _this = this;
        return this._http.get(this.apiUrl)
            .map(function (res) { return res.json(); })
            .subscribe(function (data) {
            _this.data = data.Nodes;
            console.log(_this.data);
        });
    };
    UserComponent.prototype.getsensor = function () {
        var _this = this;
        return this._http.get(this.apiUrl)
            .map(function (res) { return res.json(); })
            .subscribe(function (sensor) {
            _this.sensor = sensor.Nodes;
            //console.log(this.sensor);
        });
    };
    // switch test output
    UserComponent.prototype.check1 = function (e) {
        console.log(e);
        console.log(e.target.checked);
        console.log(e.target.value);
        if (e.target.checked == true) {
            var packet = new __WEBPACK_IMPORTED_MODULE_3_ng2_mqtt_mqttws31__["Paho"].MQTT.Message("Zigbee.Nodes['" + e.target.value + "'].On(1)");
            packet.destinationName = "EzZigBee/Demo/LoadCode";
            this.client.send(packet);
        }
        else {
            var packet = new __WEBPACK_IMPORTED_MODULE_3_ng2_mqtt_mqttws31__["Paho"].MQTT.Message("Zigbee.Nodes['" + e.target.value + "'].Off(1)");
            packet.destinationName = "EzZigBee/Demo/LoadCode";
            this.client.send(packet);
        }
    };
    UserComponent.prototype.check2 = function (e) {
        console.log(e);
        console.log(e.target.checked);
        console.log(e.target.value);
        if (e.target.checked == true) {
            var packet = new __WEBPACK_IMPORTED_MODULE_3_ng2_mqtt_mqttws31__["Paho"].MQTT.Message("Zigbee.Nodes['" + e.target.value + "'].On(2)");
            packet.destinationName = "EzZigBee/Demo/LoadCode";
            this.client.send(packet);
        }
        else {
            var packet = new __WEBPACK_IMPORTED_MODULE_3_ng2_mqtt_mqttws31__["Paho"].MQTT.Message("Zigbee.Nodes['" + e.target.value + "'].Off(2)");
            packet.destinationName = "EzZigBee/Demo/LoadCode";
            this.client.send(packet);
        }
    };
    UserComponent.prototype.onConnected = function () {
        console.log("Connected");
        this.client.subscribe("EzZigBee/Demo/LoadCode");
        // this.sendMessage('Web connected to mqtt ');
    };
    UserComponent.prototype.sendMessage = function (message) {
        var packet = new __WEBPACK_IMPORTED_MODULE_3_ng2_mqtt_mqttws31__["Paho"].MQTT.Message(message);
        packet.destinationName = "EzZigBee/Demo/LoadCode";
        this.client.send(packet);
    };
    UserComponent.prototype.onMessage = function () {
        this.client.onMessageArrived = function (message) {
            console.log('Message arrived : ' + message.payloadString);
        };
    };
    UserComponent.prototype.onConnectionLost = function () {
        this.client.onConnectionLost = function (responseObject) {
            console.log('Connection lost : ' + JSON.stringify(responseObject));
        };
    };
    UserComponent.prototype.beep = function (name) {
        console.log(name.toString());
        //console.log("Zigbee.Nodes['"+name+"'].Beep()");
        var packet = new __WEBPACK_IMPORTED_MODULE_3_ng2_mqtt_mqttws31__["Paho"].MQTT.Message("Zigbee.Nodes['" + name + "'].Beep()");
        packet.destinationName = "EzZigBee/Demo/LoadCode";
        this.client.send(packet);
    };
    // events
    UserComponent.prototype.chartClicked = function (e) {
        console.log(e);
    };
    UserComponent.prototype.chartHovered = function (e) {
        console.log(e);
    };
...
UserComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_http__["b" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_http__["b" /* Http */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_4_ngx_bootstrap_modal__["b" /* BsModalService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4_ngx_bootstrap_modal__["b" /* BsModalService */]) === "function" && _b || Object])
], UserComponent);
